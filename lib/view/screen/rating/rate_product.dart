...
import 'package:ecommerce/controller/reviews/review_controller.dart';
...
import '../../widget/shop/product/custom_picked_image.dart';

class RateProduct extends StatelessWidget {
  RateProduct({super.key});
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      ListView.builder(
                          ...
                          itemCount: controller.orderItems.order.length,
                          itemBuilder: (context, productIndex) {
                            OrderItem completedProduct =
                                controller.orderItems.order[productIndex];
                            return Column(
                              children: [
                                Row(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    CachedNetworkImage(
                                      imageUrl:
                                          "${AppLink.productImage}${completedProduct.productImageURL}",
                                      fit: BoxFit.fill,
                                      height: 75,
                                      width: 75,
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          completedProduct.variationName ==
                                                  "null"
                                              ? SizedBox(
                                                  height: 12,
                                                )
                                              : Text(
                                                  "Variation: ${completedProduct.variationName}",
                                                  style: Theme.of(context)
                                                      .textTheme
                                                      .headline5!
                                                      .copyWith(
                            ...
                            GestureDetector(
                                ...
                                child: SizedBox(
                                  ...
                                  width: controller.selectedImages.isNotEmpty
                                      ? 90
                                      : controller.size.value.width * .94,
                                  child: DottedBorder(
